                                ...
                                <div class="my-2 ml-2">
                                    ...
                                    <div class="position-relative my-2">
                                        <!-- <div class="position-absolute btn-rating">Rating: <span v-for="item in owner.rating" :key="item.id"><i class="fas fa-star text-warning"></i></span></div> -->
                                            <button class="position-absolute btn-like text-primary"><i class="far fa-thumbs-up text-primary btn-i-like"></i>40</button>
                                        </div>
                                        <br>
                                        <div class="d-flex p-1">
                                            <h6 class="text-danger mr-2 mb-0">10Triệu  </h6>
                                        <span> - </span>
                                        <h6 class="ml-2 mb-0">  10m<sup>2</sup></h6>
                                    </div>
                                    <small class="text-muted"><i class="fas fa-angle-right pr-1"></i>ok</small>
                                </div>
                            </div>
                        </a>
                    </div>
